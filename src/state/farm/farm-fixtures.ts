...
//   testPerSecond: SerializedBigNumber
...
//   const testPerSecond = parseBigNumber(rawGlobal.testPerSecond)

//   const poolInfo = parsePoolInfo(raw.poolInfo)

//   const primaryEmissionPerSecondRaw = JSBI.divide(
//     JSBI.multiply(JSBI.BigInt(testPerSecond.toString()), JSBI.BigInt(poolInfo.allocPoint.toString())),
