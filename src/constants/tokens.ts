...
import { WQOM, Qom } from './native-token'
...
export const QOM = Qom.onChain(ChainId.MAINNET)
...
export const MQOM = makeToken('QOM', 'MQOM', 18, {
  /**
   * THis is just some mock token
   * Dont use for main net
   */
  [ChainId.MAINNET]: '0x0000000000000000000000000000000000000000',
  [ChainId.TESTNET]: TESTNET.mockQOM,
...
export const TEST = makeToken('Test', 'tst4', 18, {
  [ChainId.MAINNET]: '0x3f75ceabCDfed1aCa03257Dc6Bdc0408E2b4b026',
  [ChainId.TESTNET]: TESTNET.test || '0x067eC87844fBD73eDa4a1059F30039584586e09d',
  // Minichef Main Reward
  [ChainId.RINKEBY]: '0x655dfdd82cb10dc7fb931fd85d69887756b922fd',
})

export const XTEST = makeToken('xTest', 'XTEST', 18, {
  [ChainId.MAINNET]: MAINNET.testbar,
  [ChainId.TESTNET]: TESTNET.testbar,
