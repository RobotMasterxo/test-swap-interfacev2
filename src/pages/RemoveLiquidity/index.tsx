...
export default function RemoveLiquidity({
      ...
      <>
        <RowBetween>
          <Text color={theme.text2} fontWeight={500} fontSize={16}>
            {'TEST ' + currencyA?.symbol + '/' + currencyB?.symbol} Burned
          </Text>
          <RowFixed>
  ...
  const oneCurrencyIsWETH = Boolean(
    chainId &&
      ((currencyA && currencyEquals(WQOM[chainId], currencyA)) ||
        (currencyB && currencyEquals(WQOM[chainId], currencyB)))
  )
                  ...
                  <AutoColumn gap="10px">
                    ...
                    {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          <StyledInternalLink
                            to={`/remove/v2/${currencyA?.isNative ? WQOM[chainId].address : currencyIdA}/${
                              currencyB?.isNative ? WQOM[chainId].address : currencyIdB
                            }`}
                          >
                            Receive WQOM
                          </StyledInternalLink>
                          ...
                          <StyledInternalLink
                            to={`/remove/v2/${
                              currencyA && currencyEquals(currencyA, WQOM[chainId]) ? 'QOM' : currencyIdA
                            }/${currencyB && currencyEquals(currencyB, WQOM[chainId]) ? 'QOM' : currencyIdB}`}
                          >
                            Receive QOM
                          </StyledInternalLink>
                        ) : null}
