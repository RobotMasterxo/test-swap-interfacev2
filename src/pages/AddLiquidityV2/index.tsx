...
export default function AddLiquidity({
  ...
  const oneCurrencyIsWETH = Boolean(
    chainId &&
      ((currencyA && currencyEquals(currencyA, WQOM[chainId])) ||
        (currencyB && currencyEquals(currencyB, WQOM[chainId])))
  )
  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        history.push(`/add/v2/${currencyIdA ? currencyIdA : 'Q'}/${newCurrencyIdB}`)
      }
    },
